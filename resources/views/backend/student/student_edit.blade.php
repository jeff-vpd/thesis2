                            ...
                            <form method="post" action="{{ route('student.update')}}" id="myForm" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-10">
                                        <input name="name"  value="{{ $student->name}}" class="form-control" type="text">
                                    </div>
                                </div>
                                <!-- end row -->
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-10">
                                        <select name="grade" id="grade" class="form-select">
                                            <option  value="{{ $student->grade}}">Select Grade</option>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-10">
                                        <input name="guardian_name"  value="{{ $student->guardian_name}}" class="form-control" type="text">
                                    </div>
                                </div>
                                <!-- end row -->
                                <div class="row mb-3">
                                    <label for="example-text-input" class="col-sm-2 col-form-label">Guardian Mobile
                                        No</label>
                                    <div class="form-group col-sm-10">
                                        <input name="guardian_mobile_no"  value="{{ $student->guardian_mobile_no}}" class="form-control" type="text">
                                    </div>
                                </div>
                                <!-- end row -->
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-10">
                                        <input name="guardian_email" value="{{ $student->guardian_email}}" class="form-control" type="email">
                                    </div>
                                </div>
                                <!-- end row -->
                                <div class="row mb-3">
                                    ...
                                    <div class="form-group col-sm-10">
                                        <input name="address" value="{{ $student->address}}" class="form-control" type="text">
                                    </div>
                                </div>
                                <!-- end row -->
                                <div class="row mb-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        src=" {{ asset($student->student_image)}}" alt="Card image cap">
                                    </div>
                                </div>
                                <!-- end row -->
