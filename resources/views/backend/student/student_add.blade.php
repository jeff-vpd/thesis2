                ...
                <div class="registration-form">
                    <form method="post" action="{{ route('student.store') }}" id="myForm" enctype="multipart/form-data">
                        ...
                        <div class="text-center mb-4">
                            <h3> <span style="font-weight: 800;color:rgb(33, 63, 63);">Add Student</span> </h3>
                        </div>
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                <input name="guardian_mobile_no" class="form-control item" type="text"
                                    placeholder="Guardian Mobile Number">
                            </div>
                            <div class="form-group col-6">
                                <input name="guardian_email" class="form-control item" type="email"
